...
> [!NOTE]
> Актуальная версия: **0.48.0**. Добавлен центр управления локальными серверами, расширенная консоль, мониторинг, снимки, редактор конфигурации и безопасное завершение дерева процессов.
