...
2. Скачайте `Orbitra_Launcher_Setup_x64.exe`.
3. Выберите русский или английский язык и следуйте подсказкам мастера.
4. Для версии без установки используйте `Orbitra_Launcher_Windows.zip`.

> [!TIP]
> Установщик — рекомендуемый вариант: он создаёт ярлыки, умеет обновлять существующую установку и корректно удаляется через параметры Windows.
...
- Inno Setup 6.7+ только для сборки установщика.
