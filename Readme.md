...
> [!NOTE]
> Актуальная версия: **0.44.1**. В срочном исправлении удалён клиентский интерфейс модерации и закрыт публичный доступ к чтению и изменению жалоб. Отправка новых жалоб пользователями сохранена.
...
- жалобы на пользователей без раскрытия очереди обращений другим клиентам;
...
- жалобы на темы без публичного доступа к очереди модерации.
...
- очередь жалоб недоступна из клиентского приложения; клиент может только отправить новое обращение.
