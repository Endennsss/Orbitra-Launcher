...
> [!NOTE]
> Актуальная версия: **0.48.1**. Обновлены переходы и подсветка серверов в двухпанельном и страничном режимах, выровнены кнопки подключения и отступы. В полезные ссылки добавлена [Orbitra Station](https://github.com/Endennsss/orbitra-station), собственная сборка автора лаунчера.
...
- очистка истории недавно посещённых серверов;
...
- независимая тихая проверка выбранных серверов каждые 12 секунд;
...
- импорт серверной сборки из ZIP, готовой папки или Robust CDN;
- пошаговый мастер с проверкой архива, файла запуска, конфигурации и порта;
- запуск, штатная остановка, перезапуск и подключение из единого центра управления;
- Windows Job Object для гарантированного завершения `Robust.Server.exe` и дочерних процессов;
- мониторинг CPU, памяти, записи на диск, роста журнала и времени работы;
- консоль с поиском, фильтрами уровней, закладками, историей команд и экспортом;
- резервные снимки конфигурации, базы, сохранений, журналов или всей сборки;
- простой редактор порта, названия, онлайна, карты и режима;
- расширенный редактор TOML, YAML и JSON с проверкой синтаксиса;
- сравнение с сохранённой версией, автоматические копии и восстановление последнего рабочего состояния.
...
- автоматический статус присутствия и режим инкогнито;
