...
public static class ConfigConstants
{
    ...
    public const string CustomLatestReleaseApiUrl = "https://api.github.com/repos/Endennsss/Orbitra-Launcher/releases/latest";
    public const string CustomLauncherSiteUrl = "https://endennsss.github.io/Orbitra-Launcher/";
    public const string CustomLauncherRepositoryUrl = "https://github.com/Endennsss/Orbitra-Launcher";
    public const string CustomLauncherReleasesUrl = "https://github.com/Endennsss/Orbitra-Launcher/releases";
    public const string CustomLauncherLatestDownloadUrl = "https://github.com/Endennsss/Orbitra-Launcher/releases/latest/download/Orbitra_Launcher_Windows.zip";
    public const string CustomLauncherIssuesUrl = "https://github.com/Endennsss/Orbitra-Launcher/issues";
    public const string CustomLauncherActionsUrl = "https://github.com/Endennsss/Orbitra-Launcher/actions";
