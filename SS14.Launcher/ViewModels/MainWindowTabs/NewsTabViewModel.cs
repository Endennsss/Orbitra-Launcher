...
public partial class NewsTabViewModel : MainWindowTabViewModel
{
    ...
    [
        new("Вышел Orbitra Launcher 0.44.0", summary: "Профили получили баннеры, описание, любимый сервер, роли и отдельные окна просмотра. Добавлены точный редактор аватаров, друзья и приглашения, статусы присутствия, единый центр жалоб и модерация тем. Обновлены Discord RPC, навигация с прокруткой и фирменный стиль дополнительных окон.", date: "3 августа 2026"),
        ...
        new("В Orbitra появился центр модерации", summary: "Жалобы на игроков и темы мастерской объединены в отдельную очередь. Для служебного аккаунта доступна вкладка обработки обращений, а дополнительные окна получили единый фирменный заголовок и системные кнопки Orbitra.", date: "3 августа 2026"),
