...
public partial class NewsTabViewModel : MainWindowTabViewModel
{
    ...
    [
        new("Системный центр Orbitra", summary: "Встроенное автообновление с SHA-256, проверка целостности, обезличенные отчёты, история релизов, статус служб, сравнение серверов и управление загруженным контентом собраны в новой вкладке.", date: "2 августа 2026"),
