...
public partial class NewsTabViewModel : MainWindowTabViewModel
{
    ...
    [
        new("Надёжный запуск и диагностика", summary: "Перед подключением Orbitra проверяет адрес, сеть, аккаунт, Loader и базу контента. Ошибки получили понятные причины, автовосстановление и быстрый переход к журналам.", date: "2 августа 2026"),
