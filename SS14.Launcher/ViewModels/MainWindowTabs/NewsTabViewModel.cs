...
public partial class NewsTabViewModel : MainWindowTabViewModel
{
    ...
    [
        new("Вышел Orbitra Launcher 0.48.1", summary: "Обновлены анимации подробностей и подсветка серверов в двухпанельном и страничном режимах и избранном. Выровнены кнопки подключения и отступы. В полезные ссылки добавлена собственная сборка Orbitra Station.", date: "25 сентября 2026"),
        new("Вышел Orbitra Launcher 0.48.0", summary: "Добавлен центр локальных серверов с мастером импорта, мониторингом, консолью, снимками и редактором конфигурации. Windows Job Object гарантированно завершает всё дерево процессов сервера, а TOML, YAML и JSON получили проверку, сравнение и историю восстановления.", date: "23 августа 2026"),
        new("Вышел Orbitra Launcher 0.47.0", summary: "Добавлена сортировка серверов и избранного, ручная проверка пинга, плавное раскрытие карточек и улучшенное управление из трея.", date: "12 августа 2026"),
        new("Вышел Orbitra Launcher 0.45.0", summary: "Профили и мастерская получили новый UX, темы автора теперь можно обновлять, а скачанные публикации сохраняются в локальной библиотеке. Исправлены онлайн-статус, отчёты диагностики, авторизация, навигация, иконки, анимации и производительность списка серверов.", date: "9 августа 2026"),
